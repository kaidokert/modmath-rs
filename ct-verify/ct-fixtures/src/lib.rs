...
//! that skips this.
//!
//! Unlike fixed-bigint's harness (~170 homogeneous fixtures generated by
//! macros), this surface is small and heterogeneous — field construction,
//! mixed carrier/word types, multi-step flows — so fixtures are written
//! longhand. The discipline above is the contract; the macro layer can
//! come back if the count grows.
//!
//! # Naming
//!
